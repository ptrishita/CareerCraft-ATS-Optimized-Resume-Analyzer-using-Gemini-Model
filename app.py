...
# GenerativeAI module is configured with the Google API key stored in the environment variable GOOGLE_API_KEY
genai.configure(api_key=os.getenv("GOOGLE_API_KEY"))

# Create an instance of the Generative AI model using the Gemini Pro pre-trained model from Google
